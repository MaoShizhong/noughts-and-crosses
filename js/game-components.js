export const playerFactory = (name, controller, token) => {
    return { name, controller, token };
};

export const playerOne = playerFactory('Player 1', 'human', 'X');
export const playerTwo = playerFactory('Player 2', 'human', 'O');
...
export const gameFlow = ((pOne, pTwo) => {
